...
tf.app.flags.DEFINE_float("dropout_keep_rate", 1.0, "probability of not dropping out.")
...
tf.app.flags.DEFINE_boolean("c2c", False,
                            "Set to True to assume rhs is char based too.")
  ...
  with tf.Graph().as_default():
    ...
    if FLAGS.train:
      ...
      if FLAGS.decode:
        ...
        g2p_model.decode(decode_lines, output_file, c2c=FLAGS.c2c)
